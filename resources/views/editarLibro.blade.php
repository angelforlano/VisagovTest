                    ...
                    <h2>Editar Libro</h2>
                        ...
                        <form action="{{ route('libro.update', $libro->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="title" type="text" class="form-control" id="title" value="{{ $libro->title }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="author" class="form-label">Autor</label>
                                <input name="author" type="text" class="form-control" id="author" value="{{ $libro->author }}" required>
                            </div>
